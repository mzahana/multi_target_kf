...
// SOURCE: https://github.com/aau-ros/aau_multi_robot/blob/master/explorer/src/test.cpp

#include "multi_target_kf/hungarian.h"
...
std::vector< std::vector<int> > m = { {0,10,5},
                                        {100,1000,2},
                                        {20,1,0},
                                        {10,20,1000},
                                        {1000,1000,1000}};
  ...
  Hungarian hungarian(m , 5,3, HUNGARIAN_MODE_MINIMIZE_COST) ;
